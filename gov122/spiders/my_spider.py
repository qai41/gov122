...
class GovSpider(scrapy.spiders.Spider):
    ...
    def parse(self, response):
        ...
        #15.渑池县车管所科目四考场; 16.三门峡支队科目四义马考场
        # 下面2行增加查询三门峡考练考场科目一
        ...
        # 渑池县车管所科目四考场
        mian_chi_4 = {'fzjg': '%E8%B1%ABM', 'kskm': '4','ksdd': '4112181', 'kscx': 'C1','startTime': start_time, 'endTime': '2116-06-03','zt': '0'}
        add_formdata(mian_chi_4)
        # 三门峡支队科目四义马考场
        yi_ma_4 = {'fzjg': '%E8%B1%ABM', 'kskm': '4','ksdd': '4112131', 'kscx': 'C1','startTime': start_time, 'endTime': '2116-06-03','zt': '0'}
        add_formdata(yi_ma_4)
    ...
    def after_parse(self, response):
        ...
        for each in sites.get("data"):
            ...
            print "|%s|%s|%s| %s"%(format((u'\u79d1\u76ee'+each["kskm"]), '^5'), format((each["ksrq"]+'('+each["kscc"])+')', '^16'), 
                                    format((each["kkrs"]+u'\u4eba'), '^10'), (each["kcmc"]+each["kscx"]))
